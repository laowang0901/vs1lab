...
function updateLocation(asc) {
    console.log(findLocation);
    document.getElementById("tag_latitude", "latitude").value = findLocation(asc.latitude);
    document.getElementById("tag_longitude", "longitude").value =findLocation(asc.longitude);
}
